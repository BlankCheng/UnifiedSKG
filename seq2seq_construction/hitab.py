...
class TrainDataset(Dataset):
    ...
    def __init__(self, args, raw_datasets, cache_root):
        ...
        cache_path = os.path.join(cache_root, 'hitab_train.cache')
...
class DevDataset(Dataset):
    ...
    def __init__(self, args, raw_datasets, cache_root):
        ...
        cache_path = os.path.join(cache_root, 'hitab_dev.cache')
        if os.path.exists(cache_path) and args.dataset.use_cache:
            self.extended_data = torch.load(cache_path)
        else:
            self.tab_processor = get_default_processor(max_cell_length=15,
...
class TestDataset(Dataset):
    ...
    def __init__(self, args, raw_datasets, cache_root):
        ...
        cache_path = os.path.join(cache_root, 'hitab_test.cache')
        if os.path.exists(cache_path) and args.dataset.use_cache:
            self.extended_data = torch.load(cache_path)
        else:
            self.tab_processor = get_default_processor(max_cell_length=15,
